...
const out = path.join(root, 'frontend/src/views/HomeView.vue');
  ...
  <section class="page home">
    ...
    <ul class="live-list">
      <li v-for="item in liveFeed" :key="item.id" class="live-item">
        ...
        <div class="live-body">
          <strong>{{ item.name }} \u12c8\u1322 \u12a0\u12f5\u122d\u130f\u12cb\u120d</strong>
...
fs.writeFileSync(
  out,
  vue.replace(/\\u([0-9a-fA-F]{4})/g, (_, h) => String.fromCharCode(parseInt(h, 16))),
  'utf8'
);
console.log('HomeView written');
